...
Шаги:
*	Перейти на вкладку «Торги».
*	Переключиться на режим «Лимит» в поле покупки/продажи.
...
1.	Открылась вкладка «Торги».
2.	Переход на режим «Лимит».
3.	В поле активных ордеров (ниже поля покупки/продажи) появилася созданный ордер на покупку.	
...
Шаги:
*	Перейти на вкладку «Торги».
*	В поле «Активные ордера» нажать кнопку «Отменить ордер» (иконка кретика).

Ожидаемый результат: 
1.	Открылась вкладка «Торги».
2.	Переход на режим «Лимит».
3.	В поле активных ордеров (ниже поля покупки/продажи) исчез ордер на покупку.
